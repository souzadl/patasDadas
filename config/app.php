...
return [
    ...
    'App' => [
        ...
        'defaultLocale' => env('APP_DEFAULT_LOCALE', 'br'),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '55e152482c2520fb392a5f527e0788eac18505fd5950d96f3d47b481b18a1025'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' => 465,
            //'timeout' => 30,
            'username' => 'patasdadassistema@gmail.com',
            'password' => 'P#o$d!P946K',
            'log' => true,
            'context' => [
                'ssl' => [
                    'verify_peer' => false,
