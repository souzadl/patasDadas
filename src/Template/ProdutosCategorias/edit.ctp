...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $produtosCategoria->id_produto_categoria],
                ['confirm' => __('Are you sure you want to delete # {0}?', $produtosCategoria->id_produto_categoria)]
            )
        ?></li>
...
<div class="produtosCategorias form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Produtos Categoria') ?></legend>
        <?php
