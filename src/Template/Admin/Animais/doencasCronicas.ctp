...
<div class="card">
    ...
    <div class="card-body">
        <?php
        if(isset($animal->prontuarios['doencascronicas'])){ 
            foreach($animal->prontuarios['doencascronicas'] as $index=>$doenca){
                ...
                echo ($index < count($animal->prontuarios['doencascronicas'])-1) ? ' | ' : '';
            }
        }
        ?>
    </div>
