...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $apadrinhamento->id_apadrinhamento],
                ['confirm' => __('Are you sure you want to delete # {0}?', $apadrinhamento->id_apadrinhamento)]
            )
        ?></li>
...
<div class="apadrinhamentos form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Apadrinhamento') ?></legend>
        <?php
