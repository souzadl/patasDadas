...
?>
 <div class="adotaveis form large-9 medium-8 columns content">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#adocao" role="tab" aria-controls="adocao" aria-selected="false">Adoção</a>
      </li>      
      <li class="nav-item">
    ...
    <?= $this->Form->create($adotavel, ['type' => 'file']) ?>          
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="adocao" role="tabpanel" aria-labelledby="adocao-tab">
                <?php
                    echo $this->Form->control('id_dotante', ['options' => $adotantesDisponiveis, 'label'=>'Adotante', 'empty' => 'Escolha um']);
                    echo $this->Form->control('data_adocao', ['type' => 'date', 'label' => 'Data Adoção', 'minYear' => date('Y') - 20]);                    
                    echo $this->Form->control('obs_adocao', ['type'=>'textarea', 'label'=>'Obs. Adoção']);                    
                    echo $this->Form->control('devolveu', ['type'=>'checkbox', 'label'=>'Devolveu']);
                    echo $this->Form->control('obs_devolucao', ['type'=>'textarea', 'label'=>'Obs. Devolução']);
                ?>
            </div>    
