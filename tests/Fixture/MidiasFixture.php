...
class MidiasFixture extends TestFixture
{
    ...
    public $fields = [
        'id_midia' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_midia'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id_midia' => 1,
                'data_alteracao' => '2018-08-21 16:40:43',
                'data' => '2018-08-21',
