 ...
 *
 */
class VermifugosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_vermifugos_prontuarios1_idx' => ['type' => 'index', 'columns' => ['prontuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_vermifugos_prontuarios1' => ['type' => 'foreign', 'columns' => ['prontuario_id'], 'references' => ['prontuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
